package br.com.itau.journey.rocksdb.repository;

import br.com.itau.journey.rocksdb.configuration.RocksDBConfiguration;
import br.com.itau.journey.rocksdb.configuration.RocksDBConnection;
import br.com.itau.journey.rocksdb.kv.KeyValueRepository;
...
import br.com.itau.journey.rocksdb.mapper.Mapper;
import br.com.itau.journey.rocksdb.mapper.RocksDBMapperFactory;
...
public class RocksDBKeyValueRepository<K, V> extends RocksDBConnection implements KeyValueRepository<K, V> {
    ...
    public void save(
            final K key,
            final V value
    ) throws IOException, SaveFailedException {
        try {
